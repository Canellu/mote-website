...
- Create one standard desktop widget for a room, zone, or light.
...
| 3     | `public/product/mote-widget-stack-dark.png`   | “Keep a room, zone, or light close in a desktop widget.”                               | Free capture    | The current source shows multiple widgets; prepare a release capture that represents the one-widget Free allowance or hold until Pro launches. |
